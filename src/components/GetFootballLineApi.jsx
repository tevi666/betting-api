...
import FootballCardLine from './FootballCardLine'
import Pagination from './Pagination'

const GetFootballLineApi = () => {
	const api =
		'https://api.betting-api.com/1xbet/football/line/all?token=d8bee65f9c4e427bb7d4bcc6711a98f89dcfad5f484b4192b26dbdb5d0d8c239'
	const [footballLive, setFootballLive] = useState([])
	const [loading, setLoading] = useState(false)
	const [currentPage, setCurrentPage] = useState(1)
	const [footballsPerPage] = useState(50)
	useEffect(() => {
	...
	return (
		<div>
			...
			<FootballCardLine footballs={currentFootball} loading={loading} />
		</div>
	)
}

export default GetFootballLineApi
